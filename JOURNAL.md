...
Firstly we made the github repo :p and then placed the components on the schematic:  
...
---
August 19, 2026:
now we add art to the silkscreen (both front and back!) to make it pretty:
